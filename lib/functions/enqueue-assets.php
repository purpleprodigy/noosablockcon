...
if ( $css_dev_mode_enabled ) {
	add_action( 'wp_enqueue_scripts', 'noosablockcon_enqueue_dev_styles' );
} else {
//Production CSS, autocompile
	add_action( 'beans_uikit_enqueue_scripts', 'noosablockcon_enqueue_styles', 5 );
}
/**
...
function noosablockcon_enqueue_dev_styles() {
...
function noosablockcon_enqueue_styles() {
...
// Enqueue LESS files to the UIkit compiler.
	beans_compiler_add_fragment( 'uikit', array(
		...
		CHILD_LIB . '/assets/less/core/block.less',
...
beans_add_smart_action( 'beans_uikit_enqueue_scripts', 'noosablockcon_enqueue_uikit_assets', 5 );
/**
 ...
 * @return void
 */
function noosablockcon_enqueue_uikit_assets() {
	beans_compiler_add_fragment( 'uikit', array(
...
// Google fonts
add_action( 'wp_enqueue_scripts', 'noosablockcon_add_google_fonts' );
/**
 ...
 * @return void
 */
function noosablockcon_add_google_fonts() {
	wp_enqueue_style( 'pp-google-fonts', 'https://fonts.googleapis.com/css?family=Montserrat:400,700|Raleway:300,400,600', false );
}
