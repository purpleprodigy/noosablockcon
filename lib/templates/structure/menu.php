...
add_action( 'wp', 'noosablockcon_set_up_menu_structure' );
/**
 ...
 * @return void
 */
function noosablockcon_set_up_menu_structure() {
...
add_action( 'beans_header_after_markup', 'noosablockcon_move_nav_under_header' );
/**
 ...
 * @return void
 */
function noosablockcon_move_nav_under_header() {
	echo beans_open_markup( 'noosablockcon_primary_nav', 'div', array( 'class' => 'pp-primary-nav' ) );
	?>
    <div class="uk-container uk-container-center">
		<?php echo beans_primary_menu(); ?>
    </div>
	<?php
	echo beans_close_markup( 'noosablockcon_primary_nav', 'div' );
}
