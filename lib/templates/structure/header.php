...
add_action( 'wp', 'noosablockcon_set_up_header_structure' );
/**
 ...
 * @return void
 */
function noosablockcon_set_up_header_structure() {
	// Remove Tagline
	...
	add_action( 'beans_header_before_markup', 'noosablockcon_display_above_header_widget' );
	add_action( 'beans_header', 'noosablockcon_display_header_widget' );
 ...
 * @return void
 */
function noosablockcon_display_above_header_widget() {
 ...
 * @return void
 */
function noosablockcon_display_header_widget() {
