...
add_action( 'wp', 'noosablockcon_set_up_footer_structure' );
/**
 ...
 * @return void
 */
function noosablockcon_set_up_footer_structure() {
	beans_wrap_markup( 'beans_footer', 'beans_footer_wrapper', 'div', array( 'class' => 'tm-footer-wrapper' ) );

	//Footer Widgets
	beans_add_smart_action( 'beans_footer_wrapper_prepend_markup', 'noosablockcon_display_footer_widgets' );
	/**
	 ...
	 * @return void
	 */
	function noosablockcon_display_footer_widgets() {
