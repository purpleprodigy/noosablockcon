...
add_action( 'wp', 'noosablockcon_set_up_archive_structure' );
/**
 ...
 * @return void
 */
function noosablockcon_set_up_archive_structure() {

	if ( is_archive() ) {
		beans_modify_action_callback( 'beans_post_content', 'noosablockcon_modify_beans_post_content' );
		/**
		 ...
		 * @return void
		 */
		function noosablockcon_modify_beans_post_content() {
			global $post;
		...
		add_filter( 'beans_edit_post_image_args', 'noosablockcon_resize_archive_feature_images' );
		/**
		 ...
		 * @return array
		 */
		function noosablockcon_resize_archive_feature_images( $args ) {
...
add_filter( 'beans_post_more_link_text_output', 'noosablockcon_modify_more_link_text' );
/**
 ...
 * @return string
 */
function noosablockcon_modify_more_link_text() {
	return 'Read More';
}

add_filter( 'excerpt_length', 'noosablockcon_modify_excerpt_length' );
/**
 ...
 */
function noosablockcon_modify_excerpt_length( $length ) {
	return 110;
}

add_filter( 'excerpt_more', 'noosablockcon_modify_excerpt_more' );
/**
 ...
 */
function noosablockcon_modify_excerpt_more( $more ) {
	return ' [....]';
}
