...
$noosablockcon_slideshow_enabled = (bool) get_option( 'noosablockcon_slideshow', false );

if ( $noosablockcon_slideshow_enabled ) {
	add_action( 'beans_fixed_wrap[_main]_prepend_markup', 'noosablockcon_home_slider_section' );
	/**
	 ...
	 * @return void
	 */
	function noosablockcon_home_slider_section() {
...
//Home Widgets
beans_add_smart_action( 'beans_fixed_wrap[_main]_append_markup', 'noosablockcon_display_home_widgets' );
/**
 ...
 * @return void
 */
function noosablockcon_display_home_widgets() {
